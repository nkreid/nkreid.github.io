...
- **Q:** Boundaries of level I, II, III?
  **A:** **I** — lateral to pec minor. **II** — posterior to pec minor. **III** — medial to pec minor.

- **Q:** Standard breast ALND — which levels?
  **A:** **I and II** (add III only if grossly involved).

- **Q:** Melanoma axillary dissection — which levels?
  **A:** **I, II, and III** always.

- **Q:** Superior boundary of the dissection?
  **A:** **Axillary vein.** Do not dissect above it.

- **Q:** Winged scapula on post-op day 3 — which nerve did you injure?
  **A:** **Long thoracic** — motor to serratus anterior.

- **Q:** Weakness with pull-ups / adduction of the arm after ALND?
  **A:** **Thoracodorsal nerve** — motor to latissimus dorsi.

- **Q:** Medial upper-arm numbness after ALND?
  **A:** **Intercostobrachial (T2)** sacrificed. Very common; usually not functionally significant.

- **Q:** Which nerve innervates BOTH pec major and pec minor?
  **A:** **Medial pectoral.** (Lateral pectoral → pec major only.)

- **Q:** What are the interpectoral nodes called?
  **A:** **Rotter's nodes.**

- **Q:** Lymphedema rate after ALND?
  **A:** **20–30%** at 5 years; higher with radiation to the axilla, obesity, higher node count.

- **Q:** ACOSOG Z0011 — thresholds?
  **A:** T1–T2, cN0, planned BCT + whole-breast RT, ≤ 2 positive SLNs. No benefit to completion ALND.

- **Q:** AMAROS trial — what did it show?
  **A:** For cN0 patients with a positive SLN, **axillary radiation** vs **ALND** — equivalent regional recurrence and disease-free survival, **less lymphedema with radiation**. Extends the "less axillary surgery" logic to mastectomy patients.

- **Q:** Neoadjuvant chemo with initial cN+ disease — approach to the axilla?
  **A:** If cN+ node was **clipped**, target axillary dissection (**TAD** = SLNB + removal of clipped node with dye + gamma probe + imaging localizer). Any residual disease → completion ALND.

- **Q:** How many nodes should a standard breast ALND yield?
  **A:** **≥ 10** for adequate pathologic staging.

- **Q:** Chronic lymphedema for 10 years after ALND, now with a dark purple lesion on the upper arm?
  **A:** **Stewart–Treves syndrome** (lymphangiosarcoma). Aggressive malignancy — biopsy urgently.

- **Q:** Post-op day 7 with a fluctuant swelling in the axilla after drain removal?
  **A:** **Seroma** — aspirate. Recurrent → replace drain.

- **Q:** Rare axillary complication of pericollegial cording along the arm 3 weeks post-op?
  **A:** **Axillary web syndrome** ("cording") — physical therapy, self-limiting.

- **Q:** SOZO surveillance — how often after ALND?
  **A:** **Baseline preop**, then **every 3–6 months for 3 years**, then annually. Rising L-Dex → early compression per PREVENT protocol.
...
## Related Case Preps
- [Lumpectomy + SLNB](/landmark/lumpectomy-slnb/) — first-line axillary staging.
- [Total Mastectomy ± SLNB](/landmark/simple-mastectomy-slnb/) — alternative to BCT.
- [Modified Radical Mastectomy](/landmark/modified-radical-mastectomy/) — total mastectomy + ALND en bloc.

## Related Topic Reviews
- [Breast](/landmark/topic-review/breast/) — staging, adjuvant therapy, ABSITE-level pearls.
- [Melanoma / Skin cancer](/landmark/topic-review/skin-and-soft-tissue/) — melanoma-specific nodal management (if page exists).
