...
<!-- Optional: tiny style tweak for compact, mobile-friendly tables -->
<style>
.qr-table { width:100%; }
...
|---|---|---|---|
| **Acute variceal bleed** | Resuscitate + antibiotics → **octreotide** → **banding** | **TIPS** if uncontrolled/early rebleed | Intubate if airway risk; vasopressin+NTG as bridge |
...
<details markdown="1">
<summary><strong>Liver Q&amp;A Review (condensed)</strong></summary>
...
<details markdown="1">
<summary><strong>Biliary</strong></summary>
...
<details markdown="1">
<summary><strong>Biliary Q&amp;A Review (condensed)</strong></summary>
